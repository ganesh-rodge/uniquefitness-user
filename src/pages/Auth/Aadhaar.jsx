  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        if (!userData.customWorkoutSchedule || userData.customWorkoutSchedule.length === 0) {
          navigate("/create-schedule"); // Force schedule creation
        } else {
          navigate("/dashboard"); // User already has schedule
        }
      } else {
