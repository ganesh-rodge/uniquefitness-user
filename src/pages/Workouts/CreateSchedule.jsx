    ...
    <div className="min-h-screen bg-[#181A1B] flex flex-col items-center justify-center px-2 py-8">
      <div className="w-full max-w-md mx-auto bg-[#10151F] rounded-xl shadow-lg p-6 flex flex-col gap-4">
        <div className="flex items-center gap-2 mb-2">
          <button onClick={handleCancel} className="text-[#EAB308] text-lg font-bold flex items-center gap-1 cursor-pointer">
            <FaArrowLeft /> Back
          </button>
        ...
        <div className="flex flex-col gap-4 mb-4">
          {days.map((day) => (
            <div key={day}>
              ...
              <button
                className="w-full bg-white rounded-md py-4 px-2 text-left font-semibold text-gray-700 shadow focus:outline-none focus:ring-2 focus:ring-yellow-400 cursor-pointer"
        ...
        <button className="text-gray-400 w-full py-2 cursor-pointer"
